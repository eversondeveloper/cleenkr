...
export default function ComponenteVendas() {
      ...
      <SecaoPagina>
        <div className="w-full h-full flex items-center justify-center">
          <div className="bg-card p-10 rounded-xl border-2 border-primary text-center max-w-md shadow-2xl">
            ...
            <h2 className="text-foreground mb-2.5 font-light text-2xl">
              Sistema não Configurado
            </h2>
            <p className="text-muted-foreground mb-7 leading-relaxed">
              Os dados da empresa emissora foram removidos ou não existem.
            </p>
            <button
  ...
  return (
    <SecaoPagina layout="row" semScrollGlobal={true}>
      <ToastMensagem
        mensagem={mensagemFlutuante}
        onClose={() => setMensagemFlutuante('')}
      />
          ...
          <div className="flex flex-col items-center justify-center w-full h-full text-center gap-5">
            ...
            <div className="text-muted-foreground text-base flex flex-col gap-4 w-[60%]">
              ...
              <div className="flex justify-center gap-2.5 text-sm text-muted-foreground flex-wrap">
                <span>
                  <strong className="text-primary mr-1">[MOUSE]</strong> Selecionar Produtos
                </span>
                <span>
                  <strong className="text-primary mr-1">[BACKSPACE]</strong> Excluir Produtos
                </span>
                <span>
                  <strong className="text-primary mr-1">[F2]</strong> Métodos de Pagamento
                </span>
                <span>
                  <strong className="text-primary mr-1">[ESC]</strong> Cancelar Venda
                </span>
                <span>
                  <strong className="text-primary mr-1">[ENTER]</strong> Finalizar Venda
                </span>
              </div>
            </div>
          </div>
